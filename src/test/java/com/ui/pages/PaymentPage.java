...
public class PaymentPage extends BrowserUtility {
	...
	private static final By CONFIRM_PAYMENT_BUTTON_LOCATOR = By
			.xpath("//p[contains(@class,\"cart_navigation clearfix\")]/button");
	private static final By ALERT_SUCCESS_MESSAGE_LOCATOR = By.xpath("//p[contains(@class,\"alert alert-success\")]");
