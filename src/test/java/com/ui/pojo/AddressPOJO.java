...
public class AddressPOJO {
	...
	public AddressPOJO(String company, String addressLine1, String addressLine2, String city, String postCode,
			String homePhoneNumber, String mobileNumber, String otherInformation, String adressAlias, String state) {
		super();
	...
	public String toString() {
		return "AddressPOJO [company=" + company + ", addressLine1=" + addressLine1 + ", addressLine2=" + addressLine2
				...
				+ ", mobileNumber=" + mobileNumber + ", otherInformation=" + otherInformation + ", adressAlias="
				+ adressAlias + ", state=" + state + "]";
	}
